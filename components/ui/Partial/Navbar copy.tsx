...
export const Navbar = () => {
  ...
  return (
    <Box sx={{ flexGrow: 1, padding: '0px 40px' }}>
      ...
      <AppBar position='fixed' open={sidemenuOpen}>
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            <NextLink href={'/'} passHref>
              <Link>
                <Button sx={{ marginLeft: theme.spacing(10) }}>MARKET</Button>
              </Link>
            </NextLink>
            <NextLink href={'/'} passHref>
              <Link>
                <Button sx={{ marginLeft: theme.spacing(6) }}>STATS</Button>
              </Link>
            </NextLink>
            <NextLink href={'/'} passHref>
              <Link>
                <Button sx={{ marginLeft: theme.spacing(6) }}>FAQ</Button>
              </Link>
            </NextLink>
            <NextLink href={'/'} passHref>
              <Link>
