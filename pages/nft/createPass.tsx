                    ...
                    <div>
                      ...
                      <div className='mt-1 flex rounded-md shadow-sm'>
                        <input
                          ...
                          name='price'
                          id='price'
                          className='focus:ring-indigo-500 text-gray focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300'
                          placeholder='0.8'
                        />
                      </div>
                    </div>
                  ...
                  <div className='px-4 py-5 bg-white space-y-6 sm:p-6'>
                    ...
                    <div>
                      ...
                      <div className='mt-1'>
                        <textarea
                          ...
                          name='description'
                          rows={3}
                          className='shadow-sm focus:ring-indigo-500 text-gray focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md'
                    ...
                    {nftMeta.image ? (
                      ...
                      <div>
                        ...
                        <div className='mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray border-dashed rounded-md'>
                      ...
                      {nftMeta.attributes.map(attribute => (
                        ...
                        >
                          ...
                          <input
                            ...
                            className='mt-1 placeholder:text-gray text-gray focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray rounded-md'
                          />
                        </div>
                      ))}
                    </div>
