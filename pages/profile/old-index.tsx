                      ...
                      <li
                        ...
                        >
                          ...
                          <button type="button" className="absolute inset-0 focus:outline-none">
                            <span className="sr-only">View details for {nft.meta ? nft.meta.name : ''}</span>
                          </button>
                        </div>
                        <p className="mt-2 block text-sm font-medium text-gray-900 truncate pointer-events-none">
                          {nft.meta ? nft.meta.name : ''}
                        </p>
                      </li>
                    ))}
                  </ul>
              ...
              <div className="pb-16 space-y-6">
                <div>
                  <div className="block w-full aspect-w-10 aspect-h-7 rounded-lg overflow-hidden">
                    <img src={activeNft.meta ? activeNft.meta.image : ''} alt="" className="object-cover" />
                  </div>
                  <div className="mt-4 flex items-start justify-between">
                    <div>
                      <h2 className="text-lg font-medium text-gray-900">
                        <span className="sr-only">Details for </span>
                        {activeNft.meta ? activeNft.meta.name : ''}
                      </h2>
                      <p className="text-sm font-medium text-gray-500">{activeNft.meta ? activeNft.meta.description : ''}</p>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <dl className="mt-2 border-t border-b border-gray-200 divide-y divide-gray-200">
                    { activeNft.meta ? activeNft.meta.attributes.map((attr) => (
